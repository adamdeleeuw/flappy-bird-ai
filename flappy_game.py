...
class Base:
    ...
    # cycling of two imgs to animate the base
    def move(self):
        self.x1 -= self.VEL
        self.x2 -= self.VEL
...
# Updates:
# 1. Modularize
# 2. Use pickle to save best bird and be able to use it
# 3. Define GEN not using global vars
# 4. Add more neural net visualization